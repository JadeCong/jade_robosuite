...
from .hmfc import HybridMotionForceController  # Hybrid Motion/Force Controller(by JadeCong)
...
def controller_factory(name, params):
    ...
    if name == "HMFC":
        return HybridMotionForceController(**params)  # Hybrid Motion/Force Controller(by JadeCong)
