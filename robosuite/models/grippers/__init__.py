...
from .ultrasound_probe_gripper import UltrasoundProbeGripper  # Ultrasound Probe Gripper(by JadeCong)
...
GRIPPER_MAPPING = {
    ...
    "UltrasoundProbeGripper": UltrasoundProbeGripper,  # Ultrasound Probe Gripper(by JadeCong)
    None: NullGripper,
}
